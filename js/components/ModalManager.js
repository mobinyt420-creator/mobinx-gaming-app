    ...
    case 'googleLogin':
      ...
      bodyContent = `
        <div style="display: flex; flex-direction: column; align-items: center; text-align: center; gap: 14px;">
          <div style="width: 56px; height: 56px; border-radius: var(--radius-full); background: #ffffff; border: 1px solid var(--border-light); display: flex; align-items: center; justify-content: center; box-shadow: var(--shadow-sm);">
          ...
          <div>
            <h4 style="font-size: 15px; font-weight: 800; color: var(--text-main);">Welcome to Mobin X</h4>
            <p style="font-size: 11.5px; color: var(--text-secondary);">Enter your Gmail to sync your account, diamonds, and sensitivities.</p>
          </div>

          <div style="background: var(--primary-light); border: 1px solid rgba(37, 99, 235, 0.2); border-radius: var(--radius-md); padding: 8px 12px; font-size: 11px; color: var(--primary); font-weight: 600; text-align: left; width: 100%;">
            🛡️ <b>Firebase Ready:</b> In Phase 2, this modal will connect directly to Firebase Authentication.
          </div>
          ...
          <div style="display: flex; gap: 10px; width: 100%; margin-top: 4px;">
            ...
            <button class="btn-primary" id="btn-confirm-google-login" style="flex: 2; display: flex; align-items: center; justify-content: center; gap: 6px;">
