    ...
    <div class="view-container profile-view">
      ...
      <div class="profile-hero" style="${isAdmin ? 'background: linear-gradient(135deg, #1e1b4b 0%, #1e3a8a 50%, #7c3aed 100%);' : ''}">
        <div class="profile-avatar-large">
          <img src="${user.avatar || 'assets/images/avatar_user.jpg'}" alt="${user.username || 'Player'}" onerror="this.src='assets/images/avatar_user.jpg'" />
        </div>
        ...
        <button class="btn-secondary" id="btn-profile-google-login" style="padding: 6px 14px; font-size: 11.5px; margin-top: 6px; border-radius: var(--radius-full); background: rgba(255,255,255,0.95); cursor: pointer;">
